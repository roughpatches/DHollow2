...
export const ENCOUNTER_NODES = [
  ...
  {
    id: 'cutting',
    name: 'The rock is in the path and somebody is breaking it',
    zones: ['greywood'],
    nature: 'hazard',
    weight: { day: 3, night: 2 },
    read: { skill: 'mining', line: 'There are wedges in that rock, and whoever put them there has been at it long enough to be sick of it.' },
    xp: [8, 14],
    con: [-1, 0],
    body: [
      'The path runs straight into a boulder that came down onto it and stopped there, and there is no way round that is not the long way. There is a gang on it now with bars and wedges and a fire set against the near side of it, and they have been at it since dawn.',
    ],
    ways: [
      {
        text: 'Get in and break it, which is quicker than waiting.',
        skill: 'mining',
        dc: 12,
        tried: 'Along the grain of it and down from the top, and never standing under what is being moved.',
        held: 'It comes apart in an hour and the gang are glad enough to say so.',
        lost: 'It comes apart on top of the party, which is one way of moving it.',
        spoils: { stone: [1, 3] },
        lostCon: 3,
      },
      {
        text: 'Get the gang to let you over it.',
        skill: 'persuasion',
        dc: 12,
        tried: 'They have been at it since dawn and they are not being paid by the hour.',
        held: 'Over the top, one at a time, and somebody gives you a hand down at the far end.',
        lost: 'The long way round, in the dark, with the sound of hammers behind you the whole way.',
        lostCon: 2,
      },
    ],
  },
