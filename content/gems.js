// The nine stones, what each one is worth worn, and what it looks like coming out of the
// ground. A gem is cut on the wheel in the corner of the smithy and worn in the Charm
// slot, one at a time; see src/charm.js.
//   id     — how content/recipes.js and src/charm.js refer to it.
//   name   — the cut stone's name. What it is called worn is the grade and this: a Fine
//            Sapphire, a Flawless Ruby.
//   tier   — 1, 2 or 3, and the whole of what a tier means is the length of `stats`: a
//            tier one stone moves one number, a tier three stone moves three. It also
//            says how hard the stone is to cut and where it is dug; see below.
//   rough  — the material id it is cut from, out of content/materials.js. That is what
//            drops; this list is what it becomes.
//   stats  — the numbers it moves, `tier` of them. One of:
//              con                    — the constitution a run sets out with
//              hp, hit, guard, harm   — the four a fighter fights on
//              any skill id           — a point of it, on top of what was spent there.
//                                       A stone can hand somebody a skill they have no
//                                       points in at all, and that counts as having it:
//                                       a Sapphire is a way onto work you could not
//                                       otherwise take.
//            How far each one moves is the grade the wheel gave it — Regular, Fine or
